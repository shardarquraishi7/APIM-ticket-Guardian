 ...
 * by directly using the applyInferenceRules function
 * 
 * This script:
 * 1. Sets up a map of answers with 7.1 = Yes
 * 2. Calls the applyInferenceRules function directly
 * 3. Verifies that 7.3 is inferred correctly
 */
...
async function testDirectInference() {
  try {
    console.log('Starting direct inference rules test...');
    
    // Set up a map of answers with 7.1 = Yes
